...
On va ici ajouter un fichier géo correspondant aux frontières des pays.

.pull-left[
- Télécharger [ce fichier](https://github.com/tsamsonov/r-geo-course/raw/master/data/ne/countries.gpkg)

- Placer le dans `inst/extdata`
]
...
#### Ajouter un fichier plat
## Comment utiliser votre fichier

La fonction `system.file()` va vous permettre ensuite d'appeler votre fichier depuis votre package installé. 

```{r}
system.file("extdata", "countries.gpkg", package = "monpremierpackage")
```
