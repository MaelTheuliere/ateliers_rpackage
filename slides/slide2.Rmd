...
.pull-left[
Une fois votre documentation effectuée, la fonction `devtools::document()` va exploiter ces balises en 1/ créant le fichier de documentation de votre fonction, `ma_fonction.Rd`, dans le répertoire `man/` et 2/ en mettant à jour le fichier NAMESPACE.
...
1/ Réfléchir au comportement attendu de la fonction.
...
# Comment faire un test ?  
.pull-left[
3/ Dans le fichier de test `test-ma_fonction.R` qui s'est ouvert, 
