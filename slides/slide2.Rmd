...
.pull-left[
<li value="3"> Dans le fichier de test `test-ma_fonction.R` qui s'est ouvert, 
on exécute la fonction et on vérifie que le résultat a les propriétés attendues.</li>
]
