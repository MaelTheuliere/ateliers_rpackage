...
Il faut ensuite la première fois déclarer cela à git par un premier push. Vous pouvez le faire de la console R grace à gert, un package qui permet de lancer des instructions git.
