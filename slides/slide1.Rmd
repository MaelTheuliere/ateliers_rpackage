...
Avant de créer votre premier package, il va falloir réaliser quelques démarches initiales à faire une bonne fois pour toute pour configurer votre poste : configuration du proxy, de git... Suivez le guide à [cette adresse](../configuration.html) pour cela. 
...
usethis::use_git_remote(url = "gitlab.com/MON_ESPACE/monpremierpackage")
```
]
]
