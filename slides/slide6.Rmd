...
- Il est souvent associée à une numérotation spécifique de votre logiciel parfois couplée à un nommage ad hoc en complément (R 4.0.3 "Bunny-Wunnies Freak Out", Ubuntu 21.04 "Hirsute Hippo")
...
Une version mineure peut contenir des corrections de bugs, des nouvelles fonctionnalités, et quelques changements ayant des impacts de retrocompatibilités. 
...
Les packages R sont versionnisés automatiquement. Quand vous créé un premier package, il a une version par défaut à 0.0.0.9000.
...
Au début de vos développements, nous n'avez pas de version, commencez déjà à tracer ce que vous ajouter à votre package.
...
- Tracer y toutes les modifications des fonctionnalités : ajout de fonctions, modification de fonction, ajout de table.

- Regroupper les suivants une typologie qui vous parait cohérente.

Exemple : 

- Nouvelles fonctionnalités
- Fonctionnalités expérimentales
- Amélioration mineures et corrections de bug
- Modification devant engendrer des modifications possibles de codes de vos utilisateurs (*breaking change*)


---
# Mettez vous d'accord sur un codification de vos versions ?

La recommandation dans l'écosystème R est d'avoir une numérotation du type majeur.mineur.patch.dev. 
Vous avez le droit de lui attribuer aussi des noms français ou anglais, souvent on chercher se base sur thème précis. Par exemple, les femmes célèbres : "v1.0.0 Rosa Parks", "v1.1.0 Marie Curie", ...)
...
.pull-left[
`usethis::use_github_release()` vous permet de créer un pré-publication de votre version active sur github. Il vous reste ensuite manuellement à la publiée depuis l'interface de github.
]
.pull-right[
